...
class PCCController:
    ...
    def update_pdl(
        ...
        my_accel = actuators.accel if actuators.accel > 0 else actuators.accel * BRAKE_MULTIPLIER
        tesla_pedal = int(round(interp(my_accel, ACCEL_LOOKUP_BP, ACCEL_LOOKUP_V)))
        ...
        if CS.pedal_interceptor_value > ZERO_ACCEL:
            tesla_brake = 0
