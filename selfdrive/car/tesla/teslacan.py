...
def create_DAS_LR_object_msg(lane,v1Class,v1Id,v1Dx,v1Dy,v1V,v2Class,v2Id,v2Dx,v2Dy,v2V):
  ...
  if (v1Dx > 0):
    ...
    v1y = int((clip(v1Dy,-22.,22.) + 22.05)/0.35/2.0) & 0x7F
    v1v = 0x0F
    if v1Dx > 0:
  ...
  if (v2Dx > 0):
    ...
    v2y = int((clip(v2Dy,-22.,22.) + 22.05)/0.35/2.0) & 0x7F
    v2v = 0x0F
    if v2Dx > 0:
  ...
  struct.pack_into('BBBBBBBB', msg, 0,lane + (v1Class << 3) + (important1 << 7),v1x, v1v + ((v1y << 4) & 0xF0),
    ((v1y >> 4) & 0x07) + ((v1Id << 3) & 0xF8), ((v1Id >> 5) & 0x03) + (v2Class << 2) +(important2 << 6) + ((v2x << 7) & 0x80),
