...
enum class EventName_baa8c5d505f727de: uint16_t {
  ...
  BRAKE_WIPE_LOW,
  BRAKE_WIPE_HIGH,
  BRAKE_WIPE_NOT_AVAILABLE,
  CC_ENABLED,
  CC_DISABLED,
  PROMPT_MAX_REGEN,
  PEDAL_CALIBRATION_NEEDED,
  GAS_PRESSED,
  EXP_MODE_ENABLED,
  EXP_MODE_DISABLED,
  PCC_ENABLED,
...
public:
  ...
  inline  ::uint32_t getCanErrorId() const;
...
public:
  ...
  inline  ::uint32_t getCanErrorId();
  inline void setCanErrorId( ::uint32_t value);
...
inline  ::uint32_t CarState::Reader::getCanErrorId() const {
  return _reader.getDataField< ::uint32_t>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}

inline  ::uint32_t CarState::Builder::getCanErrorId() {
  return _builder.getDataField< ::uint32_t>(
      ::capnp::bounded<16>() * ::capnp::ELEMENTS);
}
inline void CarState::Builder::setCanErrorId( ::uint32_t value) {
